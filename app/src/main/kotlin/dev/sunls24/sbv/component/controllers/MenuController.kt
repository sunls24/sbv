...
import dev.sunls24.biliapi.entity.video.SubtitleAiStatus
import dev.sunls24.biliapi.entity.video.SubtitleAiType
import dev.sunls24.biliapi.entity.video.SubtitleType
import dev.sunls24.sbv.R
import dev.sunls24.sbv.component.controllers.playermenu.ClosedCaptionMenuList
import dev.sunls24.sbv.component.controllers.playermenu.DanmakuMenuList
import dev.sunls24.sbv.component.controllers.playermenu.MenuNavList
import dev.sunls24.sbv.component.controllers.playermenu.PictureMenuList
import dev.sunls24.sbv.component.controllers.playermenu.PlaySpeedMenuList
    ...
    Box(
        ...
        when (selectedNavMenu) {
            ...
            VideoPlayerMenuNavItem.PlaySpeed -> {
                PlaySpeedMenuList(
                    currentSelectedPlaySpeedItem = PlaybackSpeed.fromSpeed(uiState.playSpeed),
                    onPlaySpeedChange = onPlaySpeedChange,
                    onFocusStateChange = onFocusStateChange,
                )
            }
...
enum class VideoPlayerMenuNavItem(private val strRes: Int, val icon: Int) {
    PlaySpeed(R.string.video_player_menu_picture_play_speed, R.drawable.ic_symbol_speed),
    Picture(R.string.video_player_menu_nav_picture, R.drawable.ic_symbol_image),
    Danmaku(R.string.video_player_menu_nav_danmaku, R.drawable.ic_symbol_clear_all),
    ClosedCaption(R.string.video_player_menu_nav_subtitle, R.drawable.ic_symbol_closed_caption);
...
enum class DanmakuType(val code: Int, private val strRes: Int) {
    Top(1, R.string.video_player_menu_danmaku_type_top),
    Rolling(2, R.string.video_player_menu_danmaku_type_cross),
    Bottom(3, R.string.video_player_menu_danmaku_type_bottom);
...
fun MenuControllerPreview() {
    ...
    var currentSelectedPlaySpeedItem by remember { mutableStateOf(PlaybackSpeed.x1) }
