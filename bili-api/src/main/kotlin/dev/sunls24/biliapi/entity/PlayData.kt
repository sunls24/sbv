...
data class PlayData(
    ...
    companion object {
        ...
        fun fromPlayUrlData(playUrlData: dev.sunls24.biliapi.http.entity.video.PlayUrlData): PlayData {
            val dash = playUrlData.dash
            val hasDash = dash != null
            val isPreview = !hasDash && playUrlData.durl.isNotEmpty()

            val audios = dash?.audio
            val dolbyItem = dash?.dolby?.audio?.firstOrNull()
            val flacItem = dash?.flac?.audio
        ...
        fun fromPlayUrlV2Data(playUrlV2Data: dev.sunls24.biliapi.http.entity.video.PlayUrlV2Data): PlayData {
