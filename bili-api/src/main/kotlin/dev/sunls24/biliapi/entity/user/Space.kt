...
data class SpaceVideoData(
    ...
    companion object {
        fun fromWebSpaceVideoData(webSpaceVideoData: dev.sunls24.biliapi.http.entity.user.WebSpaceVideoData) =
            SpaceVideoData(
...
data class SpaceVideo(
    ...
    companion object {
        fun fromSpaceVideoItem(spaceVideoItem: dev.sunls24.biliapi.http.entity.user.WebSpaceVideoData.SpaceVideoListItem.VListItem) =
            SpaceVideo(
