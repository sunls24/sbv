...
data class Episode(
    ...
    companion object {
        fun fromEpisode(episode: dev.sunls24.biliapi.http.entity.video.UgcSeason.Section.Episode) =
            Episode(
                id = episode.id,
                aid = episode.aid,
                bvid = episode.bvid,
        ...
        fun fromEpisode(episode: dev.sunls24.biliapi.http.entity.season.Episode) = Episode(
            id = episode.id,
            aid = episode.aid,
            cid = episode.cid,
            bvid = episode.bvid,
