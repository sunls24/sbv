package dev.sunls24.biliapi.entity
...
data class FavoriteFolderMetadata(
    ...
    companion object {
        fun fromHttpFavoriteFolderInfo(httpFavoriteFolderInfo: dev.sunls24.biliapi.http.entity.user.favorite.FavoriteFolderInfo): FavoriteFolderMetadata {
        ...
        fun fromHttpUserFavoriteFolder(httpUserFavoriteFoldersData: dev.sunls24.biliapi.http.entity.user.favorite.UserFavoriteFoldersData.UserFavoriteFolder): FavoriteFolderMetadata {
            return FavoriteFolderMetadata(
...
data class FavoriteFolderData(
    ...
    companion object {
        fun fromHttpFavoriteFolderInfoListData(httpFavoriteFolderInfoListData: dev.sunls24.biliapi.http.entity.user.favorite.FavoriteFolderInfoListData): FavoriteFolderData {
...
data class FavoriteItem(
    ...
    companion object {
        fun fromHttpFavoriteItem(httpFavoriteItem: dev.sunls24.biliapi.http.entity.user.favorite.FavoriteItem): FavoriteItem {
            return FavoriteItem(
...
data class Upper(
    ...
    companion object {
        fun fromHttpUpper(httpUpper: dev.sunls24.biliapi.http.entity.user.favorite.Upper): Upper {
            return Upper(
                mid = httpUpper.mid,
                name = httpUpper.name,
                face = httpUpper.face
